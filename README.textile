...
Registers a new filter tag for Liquid to access will_paginate and also over writes the paginate LinkRenderer so it has reference to the template controller attribute and uses ActionView::Helpers::TagHelper for constructing the pagination links.
